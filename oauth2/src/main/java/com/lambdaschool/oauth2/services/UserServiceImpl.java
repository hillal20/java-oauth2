...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    public void delete(long id) {
        userrepos.findById(id).orElseThrow(() -> new EntityNotFoundException("User id " + id + " not found!"));
    ...
    public User save(User user) {
        ...
        for (UserRoles ur : user.getUserroles()) {
            ...
            Role role = rolerepos.findById(id).orElseThrow(() -> new EntityNotFoundException("Role id " + id + " not found!"));
    ...
    public void deleteUserRole(long userid, long roleid) {
        ...
        rolerepos.findById(roleid).orElseThrow(() -> new EntityNotFoundException("Role id " + roleid + " not found!"));
    ...
    @Override
    public  void userNotFoundExample() {
        throw new EntityNotFoundException(" BAD  URL user not found coz the not curl is wrong !!!!!!!!!!!!!");
    }
}
