...
public class UserController {
    ...
    public ResponseEntity<?> deleteUserRoleByIds( @PathVariable long userid, @PathVariable long roleid) {
    ...
    public ResponseEntity<?> postUserRoleByIds(@PathVariable long userid, @PathVariable long roleid) { userService.addUserRole(userid, roleid);
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    @GetMapping("/bad") // hilal created this route to test the exceptions
    public ResponseEntity<?>  findUserRandomly()  { userService.userNotFoundExample();
